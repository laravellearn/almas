            ...
            <div class="row">
                <div class="col-xl-12 box-margin height-card">
                    <div class="card card-body">
                        <h4 class="card-title">تحویل کالا به کاربر</h4>
                        <hr>
                        <div class="row">
                            <div class="col-12 ">
                                <form action="{{ route('deliveries.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <select class="js-example-basic-single form-control" required name="organization_id" id="organization_id" style="width: 100%;">
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <select class="js-example-basic-single form-control" name="employee_id" id="employee_id" style="width: 100%;" required>
                                            </select>
                                        </div>


                                        <div class="form-group col-4">
                                            <label for="inputGroupFile02">تاریخ تحویل:</label>

                                            <input type="text" id="observer-example" name="deliverDate" required class="form-control observer-example">
                                            <span id="span1"></span>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <table id="invoice-item-table" class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="order_item_quantity[]" required id="order_item_quantity1" data-srno="1" class="form-control input-sm order_item_quantity" /></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#add_row', function() {
            ...
            html_code += '<td><input type="text" name="order_item_quantity[]" required id="order_item_quantity' + count + '" data-srno="' + count + '" class="form-control input-sm number_only order_item_quantity" /></td>';
