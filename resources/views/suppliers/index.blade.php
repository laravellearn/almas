            ...
            <div class="row">
                <div class="col-xl-4 box-margin height-card">
                    <div class="card card-body">
                        <h4 class="card-title">افزودن تامین کننده</h4>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="{{ route('suppliers.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" required id="exampleInputEmail111">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail111">تلفن شرکت: </label>
                                        <input type="text" class="form-control" name="phone" required id="exampleInputEmail111">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail12">موبایل:</label>
                                        <input type="text" class="form-control" name="mobile" required id="exampleInputEmail111">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail12">آدرس:</label>
                                        <input type="text" class="form-control" name="address" required id="exampleInputEmail111">
                                    </div>
                                    <div class="form-group">
