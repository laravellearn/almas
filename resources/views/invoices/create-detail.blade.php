...
@section('title', 'افزودن یک قلم به فاکتور')
    ...
    <div class="main-content">
        <nav aria-label="خرده نان" class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">افزودن یک قلم به فاکتور</li>
            </ol>
        </nav>
                ...
                <div class="row">
                    <div class="col-xl-12 box-margin height-card">
                        <div class="card card-body">
                            <h4 class="card-title">افزودن یک قلم به فاکتور شماره: {{ $invoice->invoiceID }}
                            </h4>
                            <hr>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <form method="post" id="invoice_form"
                                        action="{{ route('detail.add.post', $invoice->id) }}"
                                                ...
                                                <table id="invoice-item-table" class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="garanty"
                                                                id="order_item_garanty1" data-srno="1"
