...
@section('title', 'ثبت کالای اسقاطی')
@section('styles')
    ...
    <div class="main-content">
        <nav aria-label="خرده نان" class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ثبت کالای اسقاطی</li>
            </ol>
        </nav>
                ...
                <div class="row">
                    <div class="col-xl-12 box-margin height-card">
                        <div class="card card-body">
                            <h4 class="card-title">افزودن کالای اسقاطی</h4>
                            <hr>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="{{ route('abortions.store') }}" method="POST">
                                        @csrf
