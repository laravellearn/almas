...
@section('title','سطل زباله کالاهای تعمیری')
...
<div class="main-content">
    <nav aria-label="خرده نان" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">سطل زباله کالاهای تعمیری</li>
        </ol>
    </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-12 box-margin">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-2">سطل زباله کالاهای تعمیری</h4>
                            <a href="{{ route('repairs.index') }}" type="button" class="btn btn-danger mb-2 mr-2" style="float:left;margin-top:-37px;">
                                لیست کالاهای تعمیری
                           </a>
                           <hr>
