...
@section('title', 'ویرایش کالای تعمیری')
@section('styles')
    ...
    <div class="main-content">
        <nav aria-label="خرده نان" class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ویرایش کالای تعمیری</li>
            </ol>
        </nav>
                ...
                <div class="row">
                    <div class="col-xl-12 box-margin height-card">
                        <div class="card card-body">
                            <h4 class="card-title">ویرایش کالای تعمیری</h4>
                            <hr>
                            <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <select class="js-example-basic-single form-control"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ $category->id == $repair->parentCategory_id ? 'selected' : '' }}>
                                                            {{ $category->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-3">
                                                ...
                                                <input type="text" id="observer-example" name="inputDate" required
                                                    ...
                                                    value="{{ $repair->inputDate }}">
                                                <span id="span1"></span>

                                            </div>
                                            <div class="form-group col-3">
                                                <label for="inputGroupFile02">تاریخ خروج:</label>

                                                <input type="text" id="observer-example" name="repairDate"
                                                    class="form-control observer-example"
                                                    value="{{ $repair->inputDate }}">
                                                <span id="span1"></span>
                                                ...
                                                <select class="js-example-basic-single form-control" name="organization_id"
                                                    ...
                                                    @foreach ($organizations as $organization)
                                                        <option value="{{ $organization->id }}"
                                                            {{ $organization->id == $repair->organization_id ? 'selected' : '' }}>
                                                            {{ $organization->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <textarea class="form-control" name="description" id="exampleInputEmail111"> {{ $repair->description }}</textarea>
                                            </div>
