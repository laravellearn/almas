...
@section('title', 'ثبت کالای تعمیری')
@section('styles')
    ...
    <div class="main-content">
        <nav aria-label="خرده نان" class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ثبت کالای تعمیری</li>
            </ol>
        </nav>
                ...
                <div class="row">
                    <div class="col-xl-12 box-margin height-card">
                        <div class="card card-body">
                            <h4 class="card-title">افزودن کالای تعمیری</h4>
                            <hr>
                            <div class="row">
                                    ...
                                    <form action="{{ route('repairs.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-3">
                                                ...
                                                <input type="text" id="observer-example" name="outputDate"
                                                    class="form-control observer-example">
                                                <span id="span1"></span>
